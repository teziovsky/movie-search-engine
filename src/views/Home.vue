  ...
  <section class="page-shell">
    <div class="page-heading mb-6">
      ...
      <p class="page-subtitle">
        Fresh releases, audience favorites, and critically acclaimed picks pulled from TMDB in one polished browsing
        experience.
      </p>
    </div>

    <div class="space-y-5 pb-8">
      <CategoryCard v-for="item in categories" :key="item.title" :category="item.movies" :title="item.title" />
    </div>
  </section>
</template>
